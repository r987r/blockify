// Auto-generated testbench for dma_axi32_core0_axim_rdata
// Source: dma_axi32_core0_axim_rdata.v
// Generated by blockify generate_tb.py
// Purpose: Compile-check and basic instantiation test

`timescale 1ns/1ps

module tb_dma_axi32_core0_axim_rdata;
  ...
  // DUT instantiation
  dma_axi32_core0_axim_rdata dut (
    .clk(clk),
    .reset(reset),
  ...
  initial begin
    ...
    $display("PASS: tb_dma_axi32_core0_axim_rdata compile and instantiation test");
    $finish;
  end
  ...
  initial begin
    #10000;
    $display("TIMEOUT: tb_dma_axi32_core0_axim_rdata");
    $finish;
  end
