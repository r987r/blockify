// Auto-generated testbench for dma_axi64_core0_channels
// Source: dma_axi64_core0_channels.v
// Generated by blockify generate_tb.py
// Purpose: Compile-check and basic instantiation test

`timescale 1ns/1ps

module tb_dma_axi64_core0_channels;
  ...
  initial begin
    ...
    $display("PASS: tb_dma_axi64_core0_channels compile and instantiation test");
    $finish;
  end
  ...
  initial begin
    #10000;
    $display("TIMEOUT: tb_dma_axi64_core0_channels");
    $finish;
  end
