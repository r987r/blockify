// Auto-generated testbench for dma_axi32_reg
// Source: dma_axi32_reg.v
// Generated by blockify generate_tb.py
// Purpose: Compile-check and basic instantiation test

`timescale 1ns/1ps

module tb_dma_axi32_reg;
  ...
  initial begin
    ...
    $display("PASS: tb_dma_axi32_reg compile and instantiation test");
    $finish;
  end
  ...
  initial begin
    #10000;
    $display("TIMEOUT: tb_dma_axi32_reg");
    $finish;
  end
