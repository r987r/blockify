// Auto-generated testbench for dma_axi32_core0_channels_mux
// Source: dma_axi32_core0_channels_mux.v
// Generated by blockify generate_tb.py
// Purpose: Compile-check and basic instantiation test

`timescale 1ns/1ps

module tb_dma_axi32_core0_channels_mux;

  reg [7:0] ch_fifo_rd_valid;
  wire fifo_rd_valid;
  reg [255:0] ch_fifo_rdata;
  ...
  // DUT instantiation
  dma_axi32_core0_channels_mux dut (
  ...
  initial begin
    ...
    $display("PASS: tb_dma_axi32_core0_channels_mux compile and instantiation test");
    $finish;
  end
  ...
  initial begin
    #10000;
    $display("TIMEOUT: tb_dma_axi32_core0_channels_mux");
    $finish;
  end
