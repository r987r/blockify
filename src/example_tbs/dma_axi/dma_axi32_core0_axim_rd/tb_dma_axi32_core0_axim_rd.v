// Auto-generated testbench for dma_axi32_core0_axim_rd
// Source: dma_axi32_core0_axim_rd.v
// Generated by blockify generate_tb.py
// Purpose: Compile-check and basic instantiation test

`timescale 1ns/1ps

module tb_dma_axi32_core0_axim_rd;
  ...
  wire rd_cmd_full;
  wire ch_fifo_wr;
  wire [31:0] ch_fifo_wdata;
  wire [2:0] ch_fifo_wsize;
  wire [2:0] ch_fifo_wr_num;
  wire [2:0] rd_transfer_num;
  wire rd_transfer;
  wire [2:0] rd_transfer_size;
  wire rd_burst_cmd;
  wire rd_clr_line;
  ...
  initial begin
    ...
    $display("PASS: tb_dma_axi32_core0_axim_rd compile and instantiation test");
    $finish;
  end
  ...
  initial begin
    #10000;
    $display("TIMEOUT: tb_dma_axi32_core0_axim_rd");
    $finish;
  end
