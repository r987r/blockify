// Auto-generated testbench for dma_axi64_core0_ch
// Source: dma_axi64_core0_ch.v
// Generated by blockify generate_tb.py
// Purpose: Compile-check and basic instantiation test

`timescale 1ns/1ps

module tb_dma_axi64_core0_ch;
  ...
  initial begin
    ...
    $display("PASS: tb_dma_axi64_core0_ch compile and instantiation test");
    $finish;
  end
  ...
  initial begin
    #10000;
    $display("TIMEOUT: tb_dma_axi64_core0_ch");
    $finish;
  end
