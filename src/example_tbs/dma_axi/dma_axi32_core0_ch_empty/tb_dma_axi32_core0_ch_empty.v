// Auto-generated testbench for dma_axi32_core0_ch_empty
// Source: dma_axi32_core0_ch_empty.v
// Generated by blockify generate_tb.py
// Purpose: Compile-check and basic instantiation test

`timescale 1ns/1ps

module tb_dma_axi32_core0_ch_empty;
  ...
  initial begin
    ...
    $display("PASS: tb_dma_axi32_core0_ch_empty compile and instantiation test");
    $finish;
  end
  ...
  initial begin
    #10000;
    $display("TIMEOUT: tb_dma_axi32_core0_ch_empty");
    $finish;
  end
